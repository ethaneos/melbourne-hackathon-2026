...
const ACTIVE_OFFERS = [
  { id: 1, restaurant: "Luigi's Trattoria", category: "Italian", discount: 20, time: "3:00 PM - 5:00 PM", emoji: "🍕" },
  { id: 2, restaurant: "Tokyo Sushi Bar", category: "Japanese", discount: 30, time: "2:00 PM - 4:30 PM", emoji: "🍣" },
  { id: 3, restaurant: "Melbourne Smash Burgers", category: "American", discount: 15, time: "4:00 PM - 6:00 PM", emoji: "🍔" },
]
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-blue-600 text-white rounded-2xl p-8 mb-8 shadow-lg">
        ...
        <div className="flex gap-4">
          <input 
            ...
            className="px-4 py-3 rounded-lg text-black w-full max-w-md focus:outline-none focus:ring-2 focus:ring-blue-300"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {ACTIVE_OFFERS.map((offer) => (
          <div key={offer.id} className="bg-white border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition flex flex-col">
            ...
            <div className="p-5 flex-grow flex flex-col">
              ...
              <Link 
                ...
                className="mt-auto w-full text-center bg-blue-600 text-white font-semibold py-2.5 rounded-lg hover:bg-blue-700 transition block"
              >
                Claim Offer
              </Link>
            </div>
